...
import { Autocomplete, Box, Button, CircularProgress, Divider, Grid, Stack, TextField, Typography, useMediaQuery } from '@mui/material';
...
import { getSubDisciplines, postWiseScoreData, submitWiseScore } from '@/api/web/wisescore.action';
...
export default function SortedUniPageComponentDashboard() {
                ...
                >
                    ...
                    <Box ref={UniversityComponentRef}>
                        <Grid
                            ...
                            alignItems="center"
                        >
                            <Grid item lg={6} md={6} sm={12} xs={12} mb={{ lg: '0px', md: '0px', sm: '10px', xs: '20px' }}>
                                <Stack>
                                    <Typography
                                        color="#333"
                                        fontFamily="HankenGroteskExtraBold"
                      ...
                      <Typography variant="inherit">
                                        ...
                                        onClick={() => {
                                            if (userData?.data?.email) {
                                                mixpanelSubmit({
                                                    ...
                                                    event_type: EAnalyticsEvents.COUNTRY_SELECTION,
                                                    status: EAnalyticsStatus.SUCCESS,
                                                    reference: 'Lead',
                                                    ...
                                                    description: `User has selected ${name} in student dashboard`,
                                                });
                                            }

                                            analytics.trackEvent(EAnalyticsEvents.COUNTRY_SELECTION, {
                                                buttonName: 'Country Select either China or Korea',
                        ...
                        {filteredPrograms.length ? (
                            filteredPrograms
                                .filter((prog: any) => prog.key === activeCountry).length > 0 ? filteredPrograms
                                    .filter((prog: any) => prog.key === activeCountry).map((item: any, key: number) => (
