    ...
    return (
        <React.Fragment>
            ...
            <Tooltip
                ...
                title={
                    <>
                        <Typography>CSC Scholarship</Typography>
                        <ul>
                            <li>
                                <Typography fontSize="14px" color="#ffffff" lineHeight="14.4px" fontWeight={400} fontFamily="HankenGroteskRegular">Total Tuition fee waive</Typography>
                            </li>
                            <li>
                                <Typography fontSize="14px" color="#ffffff" lineHeight="14.4px" fontWeight={400} fontFamily="HankenGroteskRegular">Earn up to 3000 CNY/mth stipend.</Typography>
                            </li>
                            <li>
                                <Typography fontSize="14px" color="#ffffff" lineHeight="14.4px" fontWeight={400} fontFamily="HankenGroteskRegular">Accommodation fee waive.</Typography>
                            </li>
                            <li>
                                <Typography fontSize="14px" color="#ffffff" lineHeight="14.4px" fontWeight={400} fontFamily="HankenGroteskRegular">Insurance.</Typography>
                            </li>
                        </ul>
                    </>
                }
