    ...
    return (
        <React.Fragment>
            ...
            <Tooltip
                ...
                title={
                    <>
                        <Typography>Fly High Scholarship</Typography>
                        <ul>
                            <li>
                                <Typography fontSize="14px" color="#ffffff" lineHeight="14.4px" fontWeight={400} fontFamily="HankenGroteskRegular">Get your full tuition waived for first year</Typography>
                            </li>
                            <li>
                                <Typography fontSize="14px" color="#ffffff" lineHeight="14.4px" fontWeight={400} fontFamily="HankenGroteskRegular">Earn up to 1500 CNY/mth stipend (Bachelor).</Typography>
                            </li>
                            <li>
                                <Typography fontSize="14px" color="#ffffff" lineHeight="14.4px" fontWeight={400} fontFamily="HankenGroteskRegular">Earn up to 3000 CNY/mth stipend (Master).</Typography>
                            </li>
                        </ul >
                    </>
                }
