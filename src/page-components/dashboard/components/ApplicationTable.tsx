            ...
            {/* <Box padding="10px">
                            <Box display="flex" justifyContent="flex-end">
                                <CloseIcon
                                    sx={{
                                        cursor: 'pointer',
                                        color: 'var(--greyscale-500, #848484)',
                                        fontSize: '32px',
                                    }}
                            ...
                            <Box
                                ...
                                <Box
                                    ...
                                    border={activePaymentType === 'esewa' ? '1px solid var(--primary-main, #FF6B26)' : '1px solid var(--greyscale-100, #D9E2EC)'}

                                >
                                    <Image src="/payment/esewa.png" alt="esewa" width={80} height={80} />
                                    <Typography
                                        fontSize="16px"
                                        fontWeight={500}
                                    >ESewa</Typography>
                                ...
                                <Box
                                    ...
                                    borderRadius="8px"
                                    onClick={() => setActivePaymentType('stripe')}
                                    border={activePaymentType === 'stripe' ? '1px solid var(--primary-main, #FF6B26)' : '1px solid var(--greyscale-100, #D9E2EC)'}
                                    ...
                                    padding="10px 20px"
                                >
                                    <Image src="/payment/stripe.svg" alt="stripe" width={80} height={80} />
                            ...
                            >
                                <ButtonWrapper
                                    ...
                                    variant='outlined' color='primary' onClick={() => setShowPaymentOptions(false)}>
                                    Cancel
                                </ButtonWrapper>
                                <ButtonWrapper
                                    ...
                                    variant='contained' color='primary' onClick={() => handlePopUpPayment()}>
                                    {(isPaymentEsewaLoading || isPaymentLoading) && <Loader color="info" />}
                                    PayNow
                                </ButtonWrapper>
                            </Box>
                        </Box> */}
